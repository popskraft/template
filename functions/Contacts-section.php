...
function sectionContacts($siteData="") 
{
  ...
  $out = "<div class='sectionContacts row' edit='$siteSettingsPage.site_data,site_texts'>";
    ...
    $out .= "<div class='col-lg mb-5'>";
      ...
      $out .= "<div class='fs-3'><a class='link' href='$addressMap'>" . caption('show_on_map') . "</a></div>";

      $out .= "<div class='display-5 mt-4 mb-3 text-dark'>" . caption('contacts_title_openinghours') . "</div>";
      $out .= "<div class='fs-3'>$openingHouseDays</div>";
      $out .= "<div class='fs-3'>$openingHouseWE</div>";
    ...
    $out .= "<div class='col-lg-7'>";
      $out .= $map ? "<div class='contacts-map overflow-hidden border shadow rounded'>$map</div>" : "" ;
    $out .= "</div>";
