...
function langSwitcher()
{
  ...
  $i = 0;
  $out .= "<div class='lang-switcher mb-4 mb-lg-n1'>";
  ...
  foreach (languages() as $language) {
    ...
    $divider = ($i < $count - 1) ? "<span class='divider border-start py-2'></span>" : "";

    $langStart = ($language->id == $savedLanguage->id) ? "<span class='lang-switcher-item fw-bold text-uppercase text-primary mx-2'>" : "<a class='lang-switcher-item fw-bold text-uppercase text-gray-light link mx-2' href='". page()->url ."'>";
