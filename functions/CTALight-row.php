    ...
    $out .= "<div class='sectionContent mx-auto max-w-lg-80 max-w-xxl-60 shadow bg-white border rounded' data-aos='zoom-in' edit='$edit.images_main,text_1,text_summary,link,text_2,check_off'>";
      $out .= "<div class='row align-items-center'>";
        ...
        $out .= "<div class='col-12 col-lg-8 text-center text-lg-start'>";
          $out .= "<div class='content max-w-md-80 px-3 py-5 px-lg-4'>";
            $out .= "<div class='display-5 mb-3 text-primary-dark' data-aos='zoom-in' data-aos-delay='600'>$title</div>";
            $out .= "<div class='summary' data-aos='zoom-in' data-aos-delay='800'>";
              $out .= $summary;
            $out .= "</div>";
            $out .= "<a class='btn btn-lg btn-link mt-3' href='$link' data-aos='zoom-in' data-aos-delay='800'>$linkCaption</a>";
          $out .= "</div>";
        $out .= "</div>";
